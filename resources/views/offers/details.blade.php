        ...
        <div class="row d-flex justify-content-center">
            ...
            @if($offer)
                <div class="col-md-4 mb-4">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <a id="checkout" href="{{route('offer.checkout',$offer -> price)}}"
                ...
                <div class="col-md-4 mb-4">
                    ...
                    @if(isset($success))
                        <div class="alert alert-success"> تم الدفع بنجاح</div>
                    @endif

                    @if(isset($fail))
                        <div class="alert alert-danger">فشلت عمليه الدفع برجاء المحاوله وقت اخر</div>
                    @endif
                </div>
           ...
           $.ajax({
              ...
              data: {
               ...
               success : function (data){
                  ...
                  if(data.status == true){
                        // show form of payment  <<< content = the name of section main on PaymentProviderController
